...
# Now we can replay it and then make another live call to Anthropic - fortunately the response dictionaries seem to be compatible
...
enable_replay_mode(replay_dir="examples/saves/chained_calls", replay_count=1)
