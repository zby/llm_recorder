...
class GoogleLLMRecorder(LLMRecorder):
    ...
    def dict_to_model_response(self, dict_response: Dict[str, Any]) -> GenerateContentResponse:
    ...
    def model_response_to_dict(self, model_response: GenerateContentResponse) -> Dict[str, Any]:
